...
if removed > 0:
    st.warning(f"⚠️ Removed {removed} invalid/unknown label rows.")
...
st.write(f"**Generalization Bound:** True error ≤ {bound:.3f}")
...
if st.button("Analyze Sentiment"):
    if user_input.strip() == "":
        ...
        sentiment_label = "🙂 Positive" if pred == 1 else "☹️ Negative"
